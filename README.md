...
<details>
  ...
  <ol>
    ...
    <li><a href="#acknowledgments">Köszönetnyilvánítás</a></li>
  </ol>
</details>
...
* Az _érvényes, és leját_ bérlettel rendelkező _rendszámokat_
* A _szektor(oka)t_, amely(ek)re a bérlet érvényes (volt)
* A rendszámokat használó személyek _e-mail címét_
...
* [![Matplotlib][Next.js]][Matplotlib-url]
...
> A Gmail-es levélküldéshez szükséges
```pip install --upgrade google-api-python-client google-auth-httplib2 google-auth-oauthlib```
```pip install beautifulsoup4```
> A Matplotlib, amely magával hozza a Numpy-t is
